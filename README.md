...
For example (Video has no audio):
...
<p class='util--hide'>View <a href='https://learn.co/lessons/intro-to-cli-applications'>Intro to Command Line Applications</a> on Learn.co and start learning to code for free.</p>
